...
function BookmarkCollections() {
  ...
  useEffect(() => {
    document.title = "QukLink - Bookmark Collections";
  }, []);
          ...
          <ul className="nav-list">
            ...
            <li className={activeSection === 'bookmarks' ? 'active' : ''}>
              ...
              <ul className={`submenu ${subMenus.bookmarks ? 'expanded' : ''}`}>
                ...
                <li onClick={(e) => { e.preventDefault(); navigate('/bookmarks/collections'); }} className="active">
                  <a>Collections</a>
                </li>
              </ul>
            </li>
          ...
          <section className="bookmarks-section">
              ...
              <div className="pill-tabs-container-full">
                <div className="pill-tabs-full">
                  <button 
                    ...
                    onClick={() => navigate('/bookmarks/my-bookmarks')}
                  >
                    My Bookmarks
                  </button>
            ...
            <div className="bookmarks-grid">
              ...
              <div className="collection-card">
                <div className="collection-header">
                  <div className="collection-info">
                    ...
                    <span className="collection-count">18+</span>
                  </div>
                  <span className="collection-privacy private">Private</span>
                </div>
                <div className="collection-preview">
                  <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=400&h=300&fit=crop" alt="Design Inspiration" />
                </div>
                <div className="collection-actions">
                  <button className="view-bookmarks-btn">View Bookmarks</button>
                </div>
              ...
              <div className="collection-card">
                ...
                <div className="collection-preview">
                  <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400&h=300&fit=crop" alt="Business & Finance" />
                </div>
                <div className="collection-actions">
                  <button className="view-bookmarks-btn">View Bookmarks</button>
                </div>
              ...
              <div className="collection-card">
                <div className="collection-header">
                  <div className="collection-info">
                    ...
                    <span className="collection-count">30+</span>
                  </div>
                  <span className="collection-privacy public">Public</span>
                </div>
                <div className="collection-preview">
                  <img src="https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=400&h=300&fit=crop" alt="Travel & Adventure" />
                </div>
                <div className="collection-actions">
                  <button className="view-bookmarks-btn">View Bookmarks</button>
                </div>
              ...
              <div className="collection-card">
                <div className="collection-header">
                  <div className="collection-info">
                    <h3>Food & Recipes</h3>
                    <span className="collection-count">22+</span>
                  </div>
                  <span className="collection-privacy private">Private</span>
                </div>
                <div className="collection-preview">
                  <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400&h=300&fit=crop" alt="Food & Recipes" />
                </div>
                <div className="collection-actions">
                  <button className="view-bookmarks-btn">View Bookmarks</button>
                </div>
              ...
              <div className="collection-card">
                <div className="collection-header">
                  <div className="collection-info">
                    ...
                    <span className="collection-count">15+</span>
                  </div>
                  <span className="collection-privacy public">Public</span>
                </div>
                <div className="collection-preview">
                  <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=300&fit=crop" alt="Fitness & Health" />
                </div>
                <div className="collection-actions">
                  <button className="view-bookmarks-btn">View Bookmarks</button>
                </div>
