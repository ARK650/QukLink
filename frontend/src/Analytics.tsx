...
function Analytics() {
  ...
  const [activeInsightsFilter, setActiveInsightsFilter] = useState('earnings');
  const [activeChartTab, setActiveChartTab] = useState('view');
  const [activePerformanceTab, setActivePerformanceTab] = useState('view');
  const [performanceTimeFilter, setPerformanceTimeFilter] = useState('Last 30 days');
  ...
  useEffect(() => {
    document.title = "QukLink - Analytics";
  }, []);
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (!target.closest('.widget-filter')) {
        setPerformanceDropdownOpen(false);
      }
    };

    if (profileDropdownOpen || performanceDropdownOpen) {
  ...
  }, [profileDropdownOpen, performanceDropdownOpen]);
    ...
    <div className={`dashboard ${isDarkMode ? 'dark-theme' : ''}`}>
      ...
      <main className="main-content">
        ...
        <div className="dashboard-content">
              ...
              <div className="insights-content">
                <div className="insight-item">
                  ...
                  <div className="insight-info">
                    ...
                    <div className="insight-label">Links Created</div>
                    <div className="insight-trend positive">
                      <span className="trend-arrow">↑</span>
                      <span className="trend-value">37.8% this week</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="insight-item">
                  ...
                  <div className="insight-info">
                    ...
                    <div className="insight-label">Click-Through Rate (CTR)</div>
                    <div className="insight-trend positive">
                      <span className="trend-arrow">↑</span>
                      <span className="trend-value">37.8% this week</span>
                    </div>
                ...
                <div className="insight-item">
                  ...
                  <div className="insight-info">
                    ...
                    <div className="insight-label">Estimated Revenue</div>
                    <div className="insight-trend positive">
                      <span className="trend-arrow">↑</span>
                      <span className="trend-value">37.8% this week</span>
                    </div>
          ...
          <div className="analytics-pill-nav-floating">
            <button 
              className={`pill-nav-btn ${activeInsightsFilter === 'earnings' ? 'active' : ''}`}
              onClick={() => setActiveInsightsFilter('earnings')}
            >
              Earnings
            </button>
            <button 
              className={`pill-nav-btn ${activeInsightsFilter === 'links' ? 'active' : ''}`}
              onClick={() => setActiveInsightsFilter('links')}
            >
              Links
            </button>
            <button 
              className={`pill-nav-btn ${activeInsightsFilter === 'collections' ? 'active' : ''}`}
              onClick={() => setActiveInsightsFilter('collections')}
            >
              Collections
            </button>
            <button 
              className={`pill-nav-btn ${activeInsightsFilter === 'shop' ? 'active' : ''}`}
              onClick={() => setActiveInsightsFilter('shop')}
            >
              Shop
            </button>
            <button 
              className={`pill-nav-btn ${activeInsightsFilter === 'subscribers' ? 'active' : ''}`}
              onClick={() => setActiveInsightsFilter('subscribers')}
            >
              Subscribers
            </button>
          </div>
          ...
          <section className="widget links-widget analytics-performance-widget">
            <div className="performance-header-row">
              <div className="performance-icon"></div>
              <h2>Top Performing Collections</h2>
              
              <div className="performance-tabs">
                <button 
                  className={`performance-tab ${activePerformanceTab === 'view' ? 'active' : ''}`}
                  onClick={() => setActivePerformanceTab('view')}
                >
                  View
                </button>
                <button 
                  className={`performance-tab ${activePerformanceTab === 'clicks' ? 'active' : ''}`}
                  onClick={() => setActivePerformanceTab('clicks')}
                >
                  Clicks
                </button>
                <button 
                  className={`performance-tab ${activePerformanceTab === 'earnings' ? 'active' : ''}`}
                  onClick={() => setActivePerformanceTab('earnings')}
                >
                  Earnings
                </button>
              </div>
              
              <div className="performance-filter" onClick={() => setPerformanceDropdownOpen(!performanceDropdownOpen)}>
                <span>{performanceTimeFilter}</span>
                <span className="dropdown-arrow">▼</span>
                ...
                {performanceDropdownOpen && (
                  <div className="filter-dropdown">
                    <div className="filter-option" onClick={(e) => {
                      e.stopPropagation();
                      setPerformanceTimeFilter('Last 7 days');
                      setPerformanceDropdownOpen(false);
                    }}>Last 7 days</div>
                    <div className="filter-option" onClick={(e) => {
                      e.stopPropagation();
                      setPerformanceTimeFilter('Last 30 days');
                      setPerformanceDropdownOpen(false);
                    }}>Last 30 days</div>
                    <div className="filter-option" onClick={(e) => {
                      e.stopPropagation();
                      setPerformanceTimeFilter('Last 90 days');
                      setPerformanceDropdownOpen(false);
                    }}>Last 90 days</div>
                    <div className="filter-option" onClick={(e) => {
                      e.stopPropagation();
                      setPerformanceTimeFilter('Last year');
                      setPerformanceDropdownOpen(false);
                    }}>Last year</div>
                  </div>
                )}
                ...
                <tr>
                  <td>
                    <div className="table-link-info">
                      <div className="link-name">Pack Of CC Luts</div>
                      <div className="link-url">qukl.ink/macbook-pro 📋</div>
                    </div>
                  </td>
                  <td className="table-date">Fri, Apr 9</td>
                  <td className="table-views">100k Views</td>
                  <td className="table-earnings">$3,140.00</td>
                </tr>
                <tr>
                  <td>
                    <div className="table-link-info">
                  ...
                  <td className="table-date">Sat, Apr 10</td>
                  <td className="table-views">24</td>
                  <td className="table-earnings">$2,568.00</td>
                </tr>
                <tr>
                  <td>
                    <div className="table-link-info">
                  ...
                  <td className="table-date">Sun, Apr 11</td>
                  <td className="table-views">16</td>
                  <td className="table-earnings">$1,375.88</td>
                </tr>
                <tr>
                  <td>
                    <div className="table-link-info">
                  ...
                  <td className="table-date">Mon, Apr 12</td>
                  <td className="table-views">48</td>
                  <td className="table-earnings">$4,955.86</td>
                </tr>
              </tbody>
            </table>
          </section>
          ...
          <div className="dashboard-grid">
            ...
            <section className="widget views-chart-widget">
              ...
              <div className="bar-chart-container">
                {[
                  { day: 'Mon', value: 27, label: '27 views' },
                  { day: 'Tue', value: 22, label: '22 views' },
                  { day: 'Wed', value: 30, label: '24 September\n2.10k views', highlight: true },
                  { day: 'Thu', value: 19, label: '19 views' },
                  { day: 'Fri', value: 27, label: '27 views' },
                  { day: 'Sat', value: 15, label: '15 views' },
                  { day: 'Sun', value: 23, label: '23 views' }
                ].map((item, index) => (
                  <div className="bar-wrapper" key={index}>
                    <div className="bar-container">
                      <div 
                        className={`bar ${item.highlight ? 'highlight' : ''}`} 
                        style={{ height: `${item.value * 3}%` }}
                      >
                        {item.highlight && (
                          <div className="bar-tooltip">
                            <div className="tooltip-date">24 September</div>
                            <div className="tooltip-value">📊 2.10k views</div>
                          </div>
                        )}
                      </div>
                    </div>
            ...
            <section className="widget">
              ...
              <div className="device-chart-container">
                <div className="donut-chart-device">
                  <svg viewBox="0 0 200 200" width="200" height="200">
                    ...
                    <circle
                      ...
                      stroke="#52c41a"
                      strokeWidth="30"
                      strokeDasharray="1.13 377"
                      strokeDashoffset="-357"
                      transform="rotate(-90 100 100)"
                    />
                    {/* Mobile - Light Blue (4.8%) */}
                    <circle
                      cx="100"
                      cy="100"
                      r="60"
                      ...
                      stroke="#69c0ff"
                      strokeWidth="30"
                      strokeDasharray="18 377"
                      strokeDashoffset="-358.13"
                      transform="rotate(-90 100 100)"
                    />
                  </svg>
                </div>
                ...
                <div className="device-legend">
                  <div className="legend-item">
                    ...
                    <div className="legend-info">
                      ...
                      <span className="legend-percentage">94.9%</span>
                    </div>
                  </div>
                  <div className="legend-item">
                    <span className="legend-icon">📱</span>
                    <div className="legend-info">
                      ...
                      <span className="legend-percentage">0.3%</span>
                    </div>
                  </div>
                  <div className="legend-item">
                    <span className="legend-icon">📱</span>
                    <div className="legend-info">
                      ...
                      <span className="legend-percentage">4.8%</span>
                    </div>
                  </div>
                </div>
              </div>
