...
type SettingsTab = 'ad-monetization' | 'payments-payout' | 'shop' | 'subscribers';
...
function Settings() {
  ...
  const [activeTab, setActiveTab] = useState<SettingsTab>('ad-monetization');
  ...
  useEffect(() => {
    document.title = "QukLink - Settings";
  }, []);
  ...
  useEffect(() => {
    ...
    if (profileDropdownOpen || currencyDropdownOpen) {
  ...
  }, [profileDropdownOpen, currencyDropdownOpen]);
      ...
      <main className="main-content">
        ...
        <div className="dashboard-content settings-content">
          ...
          <div className="settings-pill-nav">
            <button 
              className={`pill-tab ${activeTab === 'ad-monetization' ? 'active' : ''}`}
              onClick={() => setActiveTab('ad-monetization')}
            >
              Ad Monetization
            </button>
            <button 
              className={`pill-tab ${activeTab === 'payments-payout' ? 'active' : ''}`}
              onClick={() => setActiveTab('payments-payout')}
            >
              Payments & Payout
            </button>
            <button 
              className={`pill-tab ${activeTab === 'shop' ? 'active' : ''}`}
              onClick={() => setActiveTab('shop')}
            >
              Shop
            </button>
            <button 
              className={`pill-tab ${activeTab === 'subscribers' ? 'active' : ''}`}
          ...
          <div className="settings-tab-content">
            {/* Ad Monetization Tab */}
            {activeTab === 'ad-monetization' && (
              <div className="settings-panel">
                <div className="settings-card">
                  <div className="settings-card-header">
                    <div className="settings-icon-circle">
                      <span className="settings-icon-letter">M</span>
                    </div>
                    <div className="settings-card-info">
                      <h2>Monetization</h2>
                      <p>Monetize you profile</p>
                    </div>
                  </div>
                  
                  <div className="settings-card-body">
                    <div className="settings-row">
                      <span className="settings-label">Enable ads</span>
                    ...
                    <button className="connect-google-btn">
                      <img src="/icons/google.png" alt="Google" className="google-icon" />
            ...
            {/* Payments & Payout Tab */}
            {activeTab === 'payments-payout' && (
              <div className="settings-panel">
                <div className="empty-state">
                  <div className="empty-icon">💳</div>
                  <h3>Payments & Payout</h3>
                  <p>Payment and payout settings will be available here</p>
                </div>
              </div>
            )}
            ...
            {activeTab === 'shop' && (
              <div className="settings-panel">
                <div className="settings-card">
                  <div className="settings-card-header-bar">
                    <div className="settings-bar-icon"></div>
                    <div className="settings-card-info">
                      <h2>Shop Settings</h2>
                      <p>Configure your online shop to sell products directly</p>
                    </div>
                  </div>
                  ...
                  <div className="settings-card-body">
                    <div className="settings-section">
                      <div className="settings-section-header">
                        <span className="settings-label">Enable Shop</span>
                        <label className="toggle-switch">
                          <input 
                            type="checkbox" 
                            checked={shopEnabled}
                      ...
                      <p className="settings-description">Allow selling products through your profile</p>
                    </div>
                    ...
                    <div className="settings-section">
                      ...
                      <div className="currency-dropdown">
                        ...
                        >
                          ...
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" className="dropdown-arrow">
                        ...
                        {currencyDropdownOpen && (
                          <div className="currency-dropdown-menu">
                            <button 
                              ...
                              onClick={() => {
                                setSelectedCurrency('USD -US Dollar');
                                setCurrencyDropdownOpen(false);
                              }}
                            >
                              USD -US Dollar
                            ...
                            <button 
                              className="currency-option"
                              onClick={() => {
                                setSelectedCurrency('GBP -British Pound');
                                setCurrencyDropdownOpen(false);
                              }}
                            >
                              GBP -British Pound
                            ...
                            <button 
                              className="currency-option"
                              onClick={() => {
                                setSelectedCurrency('JPY -Japanese Yen');
                                setCurrencyDropdownOpen(false);
                              }}
                            >
                              JPY -Japanese Yen
                ...
                <div className="settings-card">
                  <div className="settings-card-header-bar">
                    ...
                    <div className="settings-card-info">
                      ...
                      <p>Offer exclusive content to paying subscribers</p>
                    </div>
                  </div>
                  ...
                  <div className="settings-card-body">
                    <div className="settings-section">
                      <div className="settings-section-header">
                        <span className="settings-label">Enable Subscriptions</span>
                        <label className="toggle-switch">
                          <input 
                            type="checkbox" 
                      ...
                      <p className="settings-description">Allow users to subscribe for exclusive content</p>
                    </div>
                  </div>
                </div>
              </div>
