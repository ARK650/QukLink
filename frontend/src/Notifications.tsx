...
interface NotificationItem {
  ...
  time: string;
  isRead: boolean;
  category: 'subscriptions' | 'orders' | 'payout' | 'achievement' | 'purchases' | 'message';
...
function Notifications() {
  ...
  const [audienceFilter, setAudienceFilter] = useState<'everyone' | 'customers'>('customers');
  ...
  useEffect(() => {
    document.title = "QukLink - Notifications";
  }, []);
  ...
  useEffect(() => {
    ...
    if (profileDropdownOpen || sortDropdownOpen) {
  ...
  }, [profileDropdownOpen, sortDropdownOpen]);
  ...
  const filteredNotifications = notifications.filter(notification => {
    ...
    const categoryMatch = filters[notification.category];
    
    // Check audience filter
    const audienceMatch = audienceFilter === 'everyone' || notification.audience === audienceFilter;
  ...
  const sortedNotifications = [...filteredNotifications].sort((a, b) => {
    if (sortBy === 'Recent') {
      return a.id - b.id; // Assuming lower ID = more recent
        ...
        <div className="dashboard-content notifications-content">
          <div className="notifications-header">
            <div className="notifications-title-container">
              <div className="notification-title-icon"></div>
              <h1>Notification</h1>
            </div>
          </div>
            ...
            <div className="notifications-main">
              <div className="notifications-section">
                ...
                <button className="load-more-btn">
                  <svg className="load-more-icon" width="20" height="20" viewBox="0 0 20 20">
                    <path d="M10 3v14m0 0l4-4m-4 4l-4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  Load more
                </button>
              </div>
              ...
              <div className="filter-section">
                <div className="filter-checkboxes">
                  <label className="filter-checkbox">
                    ...
                    />
                    <span className="checkbox-label">Subscriptions</span>
                  </label>
                  ...
                  <label className="filter-checkbox">
                    <input 
                      ...
                      onChange={() => handleFilterChange('orders')}
                    />
                    <span className="checkbox-label">Orders</span>
                  </label>
                  
                  <label className="filter-checkbox">
                    <input 
                      type="checkbox" 
                      checked={filters.payout}
                      onChange={() => handleFilterChange('payout')}
                    />
                    <span className="checkbox-label">Payout</span>
                  </label>
                  ...
                  <label className="filter-checkbox">
                    <input 
                      ...
                      onChange={() => handleFilterChange('achievement')}
                    />
                    <span className="checkbox-label">Achievement</span>
                  </label>
                  ...
                  <label className="filter-checkbox">
                    <input 
                      ...
                      onChange={() => handleFilterChange('purchases')}
                    />
                    <span className="checkbox-label">Purchases</span>
                  </label>
                  ...
                  <label className="filter-checkbox">
                    <input 
                      ...
                      onChange={() => handleFilterChange('message')}
                    />
                    <span className="checkbox-label">Message</span>
                  </label>
                </div>
              ...
              <div className="audience-filter-section">
                <label className="audience-option">
                  <input 
                    type="radio" 
                    name="audience"
                    checked={audienceFilter === 'everyone'}
                    onChange={() => setAudienceFilter('everyone')}
                  />
                ...
                <label className="audience-option">
                  <input 
                    type="radio" 
                    name="audience"
                    checked={audienceFilter === 'customers'}
                    onChange={() => setAudienceFilter('customers')}
                  />
                  <span className="radio-label">Customers</span>
                </label>
              </div>
            </div>
          </div>
