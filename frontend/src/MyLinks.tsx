...
interface LinkData {
  ...
  thumbnail?: string;
  overlayText?: string;
  status: 'published' | 'draft' | 'subscriber' | 'scheduled';
  created: string;
  clicks: number;
  clicksChange: number;
  views: number;
...
function MyLinks() {
  ...
  const [activeSection] = useState('myLinks');
  const [openDropdown, setOpenDropdown] = useState<string | null>(null);
  const [activeFilter, setActiveFilter] = useState<'published' | 'draft' | 'subscriber' | 'total' | 'earnings'>('published');
  ...
  // Dummy data for links - Updated with relevant images for each product
  const [linksData] = useState<LinkData[]>([
    {
      id: '1',
    ...
    },
    {
      id: '2',
      title: 'iPhone 14 Pro',
      url: 'qukl.ink/iphone-14-pro',
      thumbnail: 'https://images.unsplash.com/photo-1664478546384-15416a5893fd?w=135&h=115&fit=crop&auto=format',
      overlayText: '30% OFF',
      status: 'published',
      created: '22 Oct, 2020',
      clicks: 16,
    ...
    },
    {
      ...
      url: 'qukl.ink/sony-headphones',
      thumbnail: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/logitech-mouse',
      thumbnail: 'https://images.unsplash.com/photo-1615663249853-223d59384750?w=135&h=115&fit=crop&auto=format',
      overlayText: '15% OFF',
      status: 'published',
      created: '17 Oct, 2020',
      clicks: 16,
    ...
    },
    {
      ...
      url: 'qukl.ink/kindle-paperwhite',
      thumbnail: 'https://images.unsplash.com/photo-1521572267360-ee0c2909d518?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/gopro-hero11',
      thumbnail: 'https://images.unsplash.com/photo-1516044734451-0add23a0133c?w=135&h=115&fit=crop&auto=format',
      overlayText: '25% OFF',
      status: 'published',
      created: '15 Nov, 2020',
      clicks: 34,
    ...
    },
    {
      ...
      url: 'qukl.ink/dji-mini-3',
      thumbnail: 'https://images.unsplash.com/photo-1507582020474-9a334a76191a?w=135&h=115&fit=crop&auto=format',
      overlayText: '40% OFF',
      status: 'subscriber',
      created: '3 Dec, 2020',
      clicks: 42,
    ...
    },
    {
      ...
      url: 'qukl.ink/samsung-g9',
      thumbnail: 'https://images.unsplash.com/photo-1593640495253-23196b27a87f?w=135&h=115&fit=crop&auto=format',
      overlayText: '20% OFF',
      status: 'published',
      created: '12 Jan, 2021',
      clicks: 28,
    ...
    },
    {
      ...
      url: 'qukl.ink/apple-watch-8',
      thumbnail: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/bose-earbuds',
      thumbnail: 'https://images.unsplash.com/photo-1572569511254-d8f925fe2cbb?w=135&h=115&fit=crop&auto=format',
      overlayText: '10% OFF',
      status: 'published',
      created: '8 Mar, 2021',
      clicks: 31,
    ...
    },
    {
      ...
      url: 'qukl.ink/canon-eos-r6',
      thumbnail: 'https://images.unsplash.com/photo-1512790182537-534c1d5e5781?w=135&h=115&fit=crop&auto=format',
      overlayText: '35% OFF',
      status: 'draft',
      created: '20 Apr, 2021',
      clicks: 37,
    ...
    },
    {
      ...
      url: 'qukl.ink/nintendo-switch',
      thumbnail: 'https://images.unsplash.com/photo-1612033448315-75b4d8521d05?w=135&h=115&fit=crop&auto=format',
      overlayText: '18% OFF',
      status: 'published',
      created: '5 May, 2021',
      clicks: 29,
    ...
    },
    {
      ...
      url: 'qukl.ink/anker-powerbank',
      thumbnail: 'https://images.unsplash.com/photo-1588855426577-2121c113550a?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/stream-deck',
      thumbnail: 'https://images.unsplash.com/photo-1658841068538-565b93b83793?w=135&h=115&fit=crop&auto=format',
      overlayText: '12% OFF',
      status: 'published',
      created: '2 Jul, 2021',
      clicks: 45,
    ...
    },
    {
      ...
      url: 'qukl.ink/keychron-k8',
      thumbnail: 'https://images.unsplash.com/photo-1595225476474-87563907a212?w=135&h=115&fit=crop&auto=format',
      overlayText: '45% OFF',
      status: 'scheduled',
      created: '16 Aug, 2021',
      clicks: 38,
    ...
    },
    {
      id: '16',
      title: 'iPad Air M1',
      url: 'qukl.ink/ipad-air-m1',
      thumbnail: 'https://images.unsplash.com/photo-1589739900209-097a20439653?w=135&h=115&fit=crop&auto=format',
      overlayText: '22% OFF',
      status: 'published',
      created: '29 Sep, 2021',
      clicks: 33,
    ...
    },
    {
      id: '17',
      title: 'AirPods Pro 2',
      url: 'qukl.ink/airpods-pro-2',
      thumbnail: 'https://images.unsplash.com/photo-1606741965326-cb990ae10021?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      title: 'PlayStation 5',
      url: 'qukl.ink/ps5',
      thumbnail: 'https://images.unsplash.com/photo-1606144042614-b2417e99c4e3?w=135&h=115&fit=crop&auto=format',
      overlayText: '28% OFF',
      status: 'published',
      created: '27 Nov, 2021',
      clicks: 36,
    ...
    },
    {
      id: '19',
      title: 'Xbox Series X',
      url: 'qukl.ink/xbox-series-x',
      thumbnail: 'https://images.unsplash.com/photo-1620292474117-1542a0a6c75a?w=135&h=115&fit=crop&auto=format',
      overlayText: '33% OFF',
      status: 'subscriber',
      created: '10 Dec, 2021',
      clicks: 24,
    ...
    },
    {
      ...
      url: 'qukl.ink/oculus-quest-2',
      thumbnail: 'https://images.unsplash.com/photo-1633493715935-3a09332b12a7?w=135&h=115&fit=crop&auto=format',
      overlayText: '16% OFF',
      status: 'published',
      created: '23 Jan, 2022',
      clicks: 30,
    ...
    },
    {
      ...
      url: 'qukl.ink/blue-yeti',
      thumbnail: 'https://images.unsplash.com/photo-1590602847991-a80d9c5def03?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/herman-miller-chair',
      thumbnail: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=135&h=115&fit=crop&auto=format',
      overlayText: '24% OFF',
      status: 'published',
      created: '21 Mar, 2022',
      clicks: 35,
    ...
    },
    {
      ...
      url: 'qukl.ink/nanoleaf-lines',
      thumbnail: 'https://images.unsplash.com/photo-1640499900754-a0b5ba1051b9?w=135&h=115&fit=crop&auto=format',
      overlayText: '38% OFF',
      status: 'draft',
      created: '4 Apr, 2022',
      clicks: 27,
    ...
    },
    {
      ...
      url: 'qukl.ink/shure-sm7b',
      thumbnail: 'https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?w=135&h=115&fit=crop&auto=format',
      overlayText: '19% OFF',
      status: 'published',
      created: '17 May, 2022',
      clicks: 32,
    ...
    },
    {
      ...
      url: 'qukl.ink/logitech-c920',
      thumbnail: 'https://images.unsplash.com/photo-1609081219443-625445a45a58?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/steelseries-keyboard',
      thumbnail: 'https://images.unsplash.com/photo-1595225476474-87563907a212?w=135&h=115&fit=crop&auto=format',
      overlayText: '21% OFF',
      status: 'published',
      created: '13 Jul, 2022',
    ...
    },
    {
      ...
      url: 'qukl.ink/focusrite-2i2',
      thumbnail: 'https://images.unsplash.com/photo-1617041330195-52a0cb3a432b?w=135&h=115&fit=crop&auto=format',
    ...
    },
    {
      ...
      url: 'qukl.ink/pixel-7',
      thumbnail: 'https://images.unsplash.com/photo-1666256993398-ade541833332?w=135&h=115&fit=crop&auto=format',
      overlayText: '42% OFF',
      status: 'published',
      created: '22 Oct, 2022',
      clicks: 40,
    ...
    },
    {
      ...
      url: 'qukl.ink/galaxy-s23',
      thumbnail: 'https://images.unsplash.com/photo-1676132252243-33f2bf934936?w=135&h=115&fit=crop&auto=format',
      overlayText: '14% OFF',
      status: 'published',
      created: '5 Nov, 2022',
      clicks: 28,
  ...
  const [analyticsLink, setAnalyticsLink] = useState<LinkData | null>(null);

  useEffect(() => {
    document.title = "QukLink - My Links";
  ...
  const handleActionsClick = (linkId: string, e: React.MouseEvent) => {
    e.stopPropagation();
    setOpenDropdown(openDropdown === linkId ? null : linkId);
  };

  const handleDropdownAction = (action: string, linkId: string) => {
    if (action === 'analytics') {
      const link = linksData.find(l => l.id === linkId);
      setAnalyticsLink(link || null);
  ...
  const handleFilterClick = (filter: 'published' | 'draft' | 'subscriber' | 'total' | 'earnings') => {
  ...
  const handleLinkSelect = (linkId: string) => {
    setSelectedLinks(prev => {
      if (prev.includes(linkId)) {
        const newSelected = prev.filter(id => id !== linkId);
        if (newSelected.length === 0) {
          setSelectAll(false);
        }
        return newSelected;
      } else {
        const newSelected = [...prev, linkId];
        if (newSelected.length === filteredLinks.length) {
          setSelectAll(true);
        }
        return newSelected;
      }
  ...
  const getFilteredLinks = () => {
    switch (activeFilter) {
      case 'published':
        return linksData.filter(link => link.status === 'published');
      case 'draft':
        return linksData.filter(link => link.status === 'draft');
      case 'subscriber':
        return linksData.filter(link => link.status === 'subscriber');
      case 'total':
        return linksData; // Show all links
      case 'earnings':
        return linksData.sort((a, b) => b.earnings - a.earnings); // Sort by earnings
      default:
        return linksData;
    }
  };
  ...
  const getFilterTitle = () => {
    switch (activeFilter) {
      ...
      case 'draft':
        return 'Draft Links';
      case 'subscriber':
        return 'Subscriber Links';
      case 'total':
        return 'All Links';
      case 'earnings':
        return 'Links by Earnings';
      default:
        return 'All Links';
    }
  };
  ...
  // Update selectAll state when filtered links change
  useEffect(() => {
    if (selectedLinks.length === 0) {
      setSelectAll(false);
    } else if (selectedLinks.length === filteredLinks.length) {
      setSelectAll(true);
    } else {
      setSelectAll(false);
    }
    ...
    <div className={`dashboard ${isDarkMode ? 'dark-theme' : ''}`}>
      ...
      <main className="main-content">
        ...
        <div className="dashboard-content">
          {showAnalyticsView && analyticsLink ? (
            ...
            <div className="analytics-view">
              <div className="analytics-header">
                ...
                <div className="analytics-link-info">
                  <img src={analyticsLink.thumbnail} alt={analyticsLink.title} className="analytics-link-thumbnail" />
                  <div className="analytics-link-details">
                    <h1>{analyticsLink.title}</h1>
                    <span className="analytics-link-url">{analyticsLink.url}</span>
                  </div>
                </div>
              </div>
                ...
                <div className="analytics-metrics-grid">
                  <div className="analytics-metric-card">
                    ...
                    <div className="metric-content">
                      <div className="metric-value">{analyticsLink.views.toLocaleString()}</div>
                      <div className="metric-label">Total Views</div>
                      <div className={`metric-change ${analyticsLink.viewsChange >= 0 ? 'positive' : 'negative'}`}>
                        {analyticsLink.viewsChange >= 0 ? '↑' : '↓'} {Math.abs(analyticsLink.viewsChange)}%
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="analytics-metric-card">
                    ...
                    <div className="metric-content">
                      <div className="metric-value">{analyticsLink.clicks.toLocaleString()}</div>
                      <div className="metric-label">Total Clicks</div>
                      <div className={`metric-change ${analyticsLink.clicksChange >= 0 ? 'positive' : 'negative'}`}>
                        {analyticsLink.clicksChange >= 0 ? '↑' : '↓'} {Math.abs(analyticsLink.clicksChange)}%
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="analytics-metric-card">
                    ...
                    <div className="metric-content">
                      <div className="metric-value">${analyticsLink.earnings.toFixed(2)}</div>
                      <div className="metric-label">Total Earnings</div>
                      <div className={`metric-change ${analyticsLink.earningsChange >= 0 ? 'positive' : 'negative'}`}>
                        {analyticsLink.earningsChange >= 0 ? '↑' : '↓'} {Math.abs(analyticsLink.earningsChange)}%
                      </div>
                    </div>
                  </div>
            ...
            /* Default View - Link Overview and Table */
            <>
          <section className="link-overview-section">
            ...
            <div className="link-overview-panel">
              <div className="overview-content">
                <div 
                  className={`overview-item ${activeFilter === 'published' ? 'active' : ''}`}
                ...
                <div 
                  className={`overview-item ${activeFilter === 'draft' ? 'active' : ''}`}
          ...
          {/* All Links Section */}
          <section className="all-links-container">
              ...
              <table className="links-table">
                ...
                <tbody>
                  {filteredLinks.length > 0 ? (
                    filteredLinks.map((link) => (
                      <tr key={link.id}>
                            ...
                            <div className="post-thumbnail">
                              ...
                              {link.overlayText && (
                                <div className="post-overlay">
                                  <span className="overlay-text">{link.overlayText}</span>
                                </div>
                              )}
                            </div>
                            <div className="post-info">
                              <div className="post-title">{link.title}</div>
                              <div className="post-url">{link.url} 📋</div>
                              <div className="post-status">
                                {link.status === 'published' && <span className="status-badge published">Published</span>}
                                {link.status === 'draft' && <span className="status-badge draft">Draft</span>}
                                {link.status === 'subscriber' && <span className="status-badge subscriber">Subscriber-Only</span>}
                                {link.status === 'scheduled' && <span className="status-badge scheduled">Scheduled</span>}
                              </div>
                            </div>
                          </div>
                        </td>
                        <td className="created-cell">{link.created}</td>
                        <td className="clicks-cell">
                          <div className="metric-cell">
                            <span className="metric-value">{link.clicks}</span>
                        ...
                        <td className="views-cell">
                          <div className="metric-cell">
                            <span className="metric-value">{link.views}</span>
                        ...
                        <td className="actions-cell">
                          <button 
                            ...
                            onClick={(e) => handleActionsClick(link.id, e)}
                          >
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          {openDropdown === link.id && (
                            <div className="actions-dropdown">
                              <button 
                                ...
                                onClick={() => handleDropdownAction('edit', link.id)}
                              >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <button 
                                className="dropdown-item"
                                onClick={() => handleDropdownAction('analytics', link.id)}
                              >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <button 
                                className="dropdown-item"
                                onClick={() => handleDropdownAction('collection', link.id)}
                              >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <button 
                                ...
                                onClick={() => handleDropdownAction('delete', link.id)}
                              >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <tr>
                      <td colSpan={5} style={{ textAlign: 'center', padding: '40px', color: 'var(--secondary-text)' }}>
