          ...
          <ul className="nav-list">
            ...
            <li className={activeSection === 'shop' ? 'active' : ''}>
              ...
              <ul className={`submenu ${subMenus.shop ? 'expanded' : ''}`}>
                <li onClick={() => navigate('/shop/products')}>
                  <a href="#">Products</a>
                </li>
                <li onClick={() => navigate('/shop/orders')} className="active">
                  <a href="#">Orders</a>
                </li>
          ...
          <section className="widget">
            ...
            <div style={{ 
              ...
              <p style={{ marginBottom: '24px', fontSize: '14px' }}>
                Customer orders will appear here once you start selling
              </p>
            </div>
          </section>
        </div>
