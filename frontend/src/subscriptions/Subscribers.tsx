...
function Subscribers() {
  ...
  useEffect(() => {
    document.title = "QukLink - Subscribers";
  }, []);
          ...
          <ul className="nav-list">
            ...
            <li className={activeSection === 'subscriptions' ? 'active' : ''}>
              ...
              <ul className={`submenu ${subMenus.subscriptions ? 'expanded' : ''}`}>
                ...
                <li onClick={(e) => { e.preventDefault(); navigate('/subscriptions/subscribers'); }} className="active">
                  <a>Subscribers</a>
                </li>
              </ul>
            </li>
      ...
      <main className="main-content">
        ...
        <div className="dashboard-content">
          <div className="welcome-section">
            <h1>Subscribers</h1>
            <p>Manage your paying subscribers</p>
          </div>
          ...
          <section className="widget">
            ...
            <div style={{ 
              ...
              <p style={{ marginBottom: '24px', fontSize: '14px' }}>
                Start creating premium content to attract subscribers
              </p>
            </div>
          </section>
        </div>
